# Auftrag
<Was gebaut/geändert werden soll — fachlich, nicht technisch vorweggenommen.>

# Kontext
- Betroffene Module: <z. B. 01-simple-filter bis 04-advanced-ai-filter>
- Zweck: <z. B. "Demo für Bank-Publikum im JUG-Talk" — beeinflusst Code-Stil-Entscheidungen>
- Relevante bestehende Teile: <Klassen/Dateien, die als Vorbild dienen oder betroffen sind>
