 ...
 * {@code StructuredCanonicalQueryIT}, which uses the same backend but bypasses the UI.
 * <p>
 ...
 * {@code FlatCustomerListViewBrowserlessIT} — verified by extracting and diffing the (method name,
