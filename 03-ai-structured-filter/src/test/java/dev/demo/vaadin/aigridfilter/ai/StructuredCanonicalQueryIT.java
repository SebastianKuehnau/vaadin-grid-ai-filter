...
class StructuredCanonicalQueryIT {
    ...
    /**
     * What variant 03 can express — the whole point of this IT, and the only thing that differs from
    ...
    private static Outcome outcomeOf(CanonicalQuery canonical) {
        return switch (canonical) {
            // Several values plus a negate flag per condition, and a range as two sibling conditions on
            // one field — nothing in the canonical set is out of reach for this filter type.
