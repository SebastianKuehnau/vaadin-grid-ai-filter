 ...
 * variant <b>02(b)</b>'s value/operator/negate tool call.
 ...
 * <p>
 * Variant 02(b) adds an operator and a negate flag to every field, which buys negation (C3), operator
 * precision (C4) and day-level date bounds (C7). What one value and one operator per field still cannot
