 ...
 * variant <b>02(a)</b>'s flat tool call.
 ...
 * negation, operator precision and every kind of range or date bound are architecturally impossible —
 * its tool has no parameter that could carry them.
 * <p>
...
class FlatCanonicalQueryIT {
    ...
    private static List<Case> cases() {
        return List.of(
                ...
                new Case("C8_DATE_RANGE", NOT_EXPRESSIBLE,
    ...
    void logTokenSummary() {
        tokenUsageAdvisor.logSummary("FlatCanonicalQueryIT");
    }
