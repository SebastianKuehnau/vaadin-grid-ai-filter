...
/**
 * Browserless UI test of {@link CustomerListView}, following {@code 03-ai-structured-filter}'s
...
class CustomerListViewBrowserlessTest extends SpringBrowserlessTest {
    ...
    static class FakeSearchAgentConfig {
         ...
         * fixture as {@code 03-ai-structured-filter}'s equivalent test — the filter type is identical
         * here, only its delivery differs.
         */
        @Bean
        @Primary
