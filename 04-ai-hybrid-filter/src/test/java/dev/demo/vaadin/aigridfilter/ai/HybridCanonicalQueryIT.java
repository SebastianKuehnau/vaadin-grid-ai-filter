 ...
 * a tool call carrying 03's {@code List<Condition>}.
 ...
 * <p>
 * The filter type is 03's, copied 1:1 — several values plus a negate flag per condition, and a range as
 * two sibling conditions on one field — so all eight categories are expressible. That this module
 * reaches the same eight as 03 while delivering the filter through a tool call is the repository's
 * closing argument: expressiveness lives in the filter type, not in the delivery mechanism.
 * <p>
